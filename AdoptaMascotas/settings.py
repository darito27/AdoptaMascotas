"""
Django settings for AdoptaMascotas project.
...
SECRET_KEY = '(ld0n4vvwlunk9#pjyfkqaz9ss3yfim*e6(c5u@-4=(!0zz_o@'
...
ROOT_URLCONF = 'AdoptaMascotas.urls'
...
WSGI_APPLICATION = 'AdoptaMascotas.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(os.path.dirname(BASE_DIR), 'AdoptaMascotas/static'),
